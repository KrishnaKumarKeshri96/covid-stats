...
export const Dashboard = ({ type, data, setType }) => {
  return (
    <div className="dashboard-counts">
      {dashboardCountKeys.map((dashboardCountKey, index) => {
        return (
          <div
            className={`dashboard-count animate-${
              index + 1
            } dashboard-count-${dashboardCountKey} ${
              type === dashboardCountKey ? "dashboard-count-active" : ""
            }`}
