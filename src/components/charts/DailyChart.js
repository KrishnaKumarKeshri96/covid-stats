  ...
  return (
    <>
      <div className="chart-title-container">
        <div className="chart-title">Spread Trends</div>
      ...
      <div className="chart-help">
        <div>
          Click on any date in the graph to view information for that specific
          date.
        </div>
        <div>Navigate using the arrow keys to go to older dates.</div>
      </div>
    </>
  );
};
